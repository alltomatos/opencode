...
const icons = {
  ...
  sparkles: {
    viewBox: "0 0 16 16",
    body: `<path d="M8 1.5L9.5 5.5L13.5 7L9.5 8.5L8 12.5L6.5 8.5L2.5 7L6.5 5.5L8 1.5Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M12.5 11.5L13 13L14.5 13.5L13 14L12.5 15.5L12 14L10.5 13.5L12 13L12.5 11.5Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>`,
  },
  edit: {
    viewBox: "0 0 16 16",
  ...
  chart: {
    viewBox: "0 0 16 16",
    body: `<path d="M2 13.5H14M3.5 13.5V8.5M7.25 13.5V4.5M11 13.5V2" stroke="currentColor" stroke-linecap="round"/>`,
  },
  status: {
    viewBox: "0 0 20 20",
  ...
  batuta: {
    viewBox: "0 0 16 16",
    body: `<path d="M3.5 12.5L11.5 4.5" stroke="currentColor" stroke-linecap="round"/><circle cx="12.5" cy="3.5" r="1.5" stroke="currentColor"/><path d="M2 14L3.5 12.5" stroke="currentColor" stroke-linecap="round"/>`,
  },
  archive: {
    viewBox: "0 0 16 16",
