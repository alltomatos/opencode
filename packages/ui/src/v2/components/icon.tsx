...
const icons = {
  ...
  breniac: {
    viewBox: "0 0 16 16",
    body: `<rect x="5.5" y="1.5" width="5" height="8" rx="2.5" stroke="currentColor"/><path d="M3 8C3 10.7614 5.23858 13 8 13C10.7614 13 13 10.7614 13 8" stroke="currentColor" stroke-linecap="round"/><path d="M8 13V14.5" stroke="currentColor" stroke-linecap="round"/>`,
  },
  archive: {
    viewBox: "0 0 16 16",
