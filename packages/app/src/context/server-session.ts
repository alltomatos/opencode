...
import { createV2Projector } from "@/context/server-session-v2-project"
import { legacyMessageSource, runInflight, type MessageLoadState, type OptimisticItem } from "@/context/server-session-helpers"
...
export function createServerSession(
  ...
  const { applyV2 } = createV2Projector({
    v2,
    data,
    setData: setData as unknown as SetStoreFunction<Parameters<typeof createV2Projector>[0]["data"]>,
    messageLoads,
    sessionApi,
    apply,
    remember,
