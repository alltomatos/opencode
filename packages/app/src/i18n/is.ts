...
export const dict = {
  ...
  "dialog.provider.omniroute.note": "Notaðu þinn eigin gátta-URL og lykil, öll líkön eru sjálfkrafa flutt inn",
  "dialog.model.selectProvider.title": "Veldu þjónustuaðila",
  "dialog.model.provider.label": "Þjónustuaðili",
  "prompt.mode.select.title": "Veldu ham",
  "prompt.mode.auto.label": "Sjálfvirkt",
  "prompt.mode.auto.description": "Stjórnar heimildaákvörðunum sjálfkrafa",
  "prompt.mode.manual.label": "Handvirkt",
  "prompt.mode.manual.description": "Spurðu alltaf áður en breytingar eru gerðar",
  "prompt.mode.edits.label": "Samþykkja breytingar",
  "prompt.mode.edits.description": "Samþykkir sjálfkrafa allar skráarbreytingar",
  "prompt.mode.plan.label": "Áætlun",
  "prompt.mode.plan.description": "Búa til áætlun áður en breytingar eru gerðar",
  "prompt.mode.bypass.label": "Sniðganga heimildir",
  "prompt.mode.bypass.description": "Samþykkja allar heimildir fyrir þessa möppu",
  "prompt.mode.group.directory": "Þessi mappa",
  "provider.omniroute.title": "Tengja Omniroute",
  "provider.omniroute.description": "Sláðu inn Omniroute gátta-URL og API lykil. Öll tiltæk líkön eru sjálfkrafa flutt inn og flokkuð eftir tegund.",
  "provider.omniroute.importing": "Flyt inn líkön...",
  "provider.omniroute.toast.imported": "{{count}} líkön flutt inn",
  "provider.omniroute.toast.importedFiltered": "{{count}} líkön flutt inn ({{skipped}} sleppt)",
  "provider.omniroute.field.combosOnly.label": "Flytja aðeins inn samsetningar",
  "provider.omniroute.field.combosOnly.description": "Sleppa venjulegum þjónustuaðila/líkan færslum og flytja aðeins inn samsett líkön",
  "common.confirm": "Staðfesta",
  "common.clearSearch": "Hreinsa leit",
  "dialog.releaseNotes.title": "Hvað er nýtt",
  "browser.panel.toggle": "Vafri",
  "browser.panel.back": "Til baka",
  "browser.panel.forward": "Áfram",
  "browser.panel.reload": "Endurhlaða",
  "browser.panel.address.placeholder": "Sláðu inn vefslóð",
  ...
  "batuta.list.create": "Ný virkni",
  "batuta.list.empty": "Engin virkni ennþá. Búðu til eina til að byrja.",
  "batuta.list.start": "Byrja",
  "batuta.model.provider.placeholder": "Þjónustuaðili",
  "batuta.model.model.placeholder": "Líkan",
  "batuta.form.title.create": "Ný Batuta virkni",
  "batuta.form.title.edit": "Breyta Batuta virkni",
  "batuta.form.field.name.label": "Heiti",
  "batuta.form.field.name.placeholder": "t.d. Endurskipuleggja greiðslueiningu",
  "batuta.form.field.goal.label": "Markmið",
  "batuta.form.field.goal.placeholder": "Hvað á stjórnandinn að ná fram?",
  "batuta.form.field.orchestrator.label": "Stjórnandalíkan",
  "batuta.form.field.workers.label": "Starfsmenn",
  "batuta.form.field.workers.label.placeholder": "Merki starfsmanns",
  "batuta.form.field.workers.add": "Bæta við starfsmanni",
  "batuta.form.field.workers.error.required": "Bættu við að minnsta kosti einum starfsmanni með merki og líkani eða skipun",
  "batuta.form.field.workers.kind.internal": "Innri",
  "batuta.form.field.workers.kind.external": "Ytri CLI",
  "batuta.form.field.workers.command.placeholder": "Skipun (t.d. claude, codex)",
  "batuta.form.field.workers.command.needsSkill": "Settu fyrst upp batuta-cli hæfnina fyrir þennan umboðsmann í Stillingar > Umboðsmenn",
  "batuta.form.field.workers.args.placeholder": "Viðföng (aðskilin með bili)",
  "batuta.form.field.worktree.label": "Einangruð vinnutré starfsmanna",
  "batuta.form.field.worktree.description": "Hver starfsmaður fær alltaf sitt eigið git vinnutré, einangrað frá aðal útgátu þinni — stjórnandinn yfirfer og sameinar niðurstöðu hvers starfsmanns. Þetta er ekki stillanlegt.",
  "batuta.form.field.directory.label": "Verkefni",
  "batuta.form.field.directory.description": "Mappan sem stjórnandi og starfsmenn þessarar virkni keyra í.",
  "batuta.form.field.directory.error.required": "Veldu eða bættu við verkefnamöppu.",
  "batuta.form.submit.create": "Búa til",
  "batuta.form.toast.created": 'Virkni "{{name}}" búin til',
  "batuta.form.toast.updated": 'Virkni "{{name}}" uppfærð',
  "batuta.remove.confirm.title": "Fjarlægja virkni?",
  "batuta.remove.confirm.description": '"{{name}}" verður fjarlægt varanlega.',
  "batuta.list.viewLive": "Skoða í beinni",
  "batuta.panel.title": "Virkni í beinni",
  "batuta.panel.empty": "Þessi virkni er ekki í gangi. Byrjaðu hana úr virknilistanum til að sjá hana í beinni.",
  "batuta.panel.status.idle": "Aðgerðalaus",
  "batuta.panel.status.busy": "Að vinna",
  "batuta.panel.status.retry": "Reyni aftur",
  "batuta.panel.architect.working": "Arkitektinn er að rannsaka verkefnið og undirbúa skjölin...",
  "batuta.panel.architect.open": "Opna arkitektalotu",
  "batuta.panel.pipeline.title": "Ferli",
  "batuta.panel.tab.graph": "Graf",
  "batuta.panel.tab.pipeline": "Ferli",
  "batuta.panel.tab.kanban": "Kanban",
  "batuta.pipeline.kanban.pending": "Í bið",
  "batuta.pipeline.kanban.inProgress": "Í vinnslu",
  "batuta.pipeline.kanban.completed": "Lokið",
  "batuta.pipeline.kanban.empty": "Ekkert hér ennþá.",
  "batuta.pipeline.phase.planning": "Áætlanagerð",
  "batuta.pipeline.phase.development": "Þróun",
  "batuta.pipeline.phase.testing": "Prófanir",
  "batuta.pipeline.phase.quality": "Gæði",
  "batuta.pipeline.phase.delivery": "Afhending",
  "batuta.pipeline.definition.missing": "Ferliflæði er ekki skilgreint ennþá — Arkitektinn mun skilgreina það á meðan hann rannsakar verkefnið. Mál birtast flokkuð eftir það.",
  "batuta.pipeline.editor.open": "Breyta flæði",
  "batuta.pipeline.editor.title": "Ferliflæði",
  "batuta.pipeline.editor.description": 'Deilt á milli allrar virkni í þessu verkefni (docs/batuta-pipeline.md). Skilgreindu áfanga sem "## Áfangaheiti" fyrirsagnir, hver á eftir fylgir listi yfir hæfnimerki (t.d. "- tdd"). Stjórnandinn les þetta reglulega aftur, svo breytingar eiga við jafnvel á meðan keyrsla stendur.',
  "batuta.pipeline.editor.save": "Vista",
  "batuta.pipeline.editor.tab.editor": "Texti",
  "batuta.pipeline.editor.tab.chat": "Spjall",
  "batuta.pipeline.chat.description": "Spjallaðu við lotu sem er takmörkuð við að lesa/skrifa aðeins docs/batuta-pipeline.md — hún birtist ekki í lotulistanum og getur ekki snert neitt annað.",
  "batuta.pipeline.chat.placeholder": "Lýstu breytingunni sem þú vilt á ferliflæðinu...",
  "batuta.pipeline.chat.send": "Senda",
  "batuta.pipeline.chat.empty": "Engin skilaboð ennþá — sendu eitt til að byrja að stilla flæðið.",
  "batuta.pipeline.chat.starting": "Að byrja spjall...",
  "batuta.pipeline.stage.architecture": "Arkitektúr",
  "batuta.pipeline.stage.architecture.detail": "Arkitektinn rannsakaði verkefnið út frá markmiði virkninnar, skrifaði/uppfærði skjölin (PRD, DER), notaði /grill-me til að skýra óvissu og skipti verkinu í mál.",
  "batuta.pipeline.stage.orchestration": "Samhæfing",
  "batuta.pipeline.stage.orchestration.detail": "Stjórnandinn tók við afhendingu Arkitektsins (skjöl + mál) og byrjaði að úthluta hverju máli til rétta starfsmannsins eða hæfnina.",
  "batuta.panel.detail.open": "Opna alla lotu",
  "batuta.panel.detail.empty": "Ekkert ennþá — beðið eftir að þessi umboðsmaður byrji að vinna.",
  "batuta.panel.ready.title": "Arkitektinn er búinn — farðu yfir áætlunina áður en þú byrjar",
  "batuta.panel.ready.dispatch": "Byrja virkni",
  "batuta.form.field.branch.label": "Grein",
  "batuta.form.field.branch.description": "Greinin sem aðal útgáta verður á þegar virknin byrjar. Skildu eftir uppgötvaðu greinina eins og hún er, eða sláðu inn nýtt heiti til að búa til og skipta yfir í hana.",
  "batuta.form.field.branch.placeholder": "Veldu grein",
  "batuta.form.field.branch.newPlaceholder": "Nýtt greinarheiti",
  "batuta.form.field.branch.create": "Ný grein",
  "settings.footer.credit": "Eftir: Alltomatos",
  "settings.title": "Stillingar",
  "settings.section.customize": "Sérsníða",
  "settings.general.section.general": "Almennt",
  "settings.general.section.experimental": "Tilraunakennt",
  "settings.general.row.use3dAnimations.title": "Nota 3D hreyfimyndir",
  "settings.general.row.use3dAnimations.description": "Birta 3D myndefni þar sem það er í boði (eins og Batuta virkni-atriðið) í stað flata 2D fallbaksins",
  "settings.general.row.devTools.title": "Forritaraverkfæri",
  "settings.general.row.devTools.description": "Opna Chromium DevTools (Console, Network) til að laga vandamál, jafnvel í framleiðsluútgáfum.",
  "settings.general.row.devTools.open": "Opna DevTools",
  "settings.general.row.debugMode.title": "Villuleitarhamur",
  "settings.general.row.debugMode.description": "Sýnir DevTools tákn í titilstiku, aðgengilegt frá hvaða skjá sem er, og virkjar fjarvillulietar (CDP) gátt jafnvel í pökkuðum/framleiðsluútgáfum. Krefst endurræsingar forritsins.",
  "settings.general.row.debugMode.descriptionOn": "Virkjað — endurræstu forritið svo fjarvillulietar-gáttin taki gildi.",
  "settings.general.row.debugMode.restart": "Endurræsa núna",
  "settings.general.row.computerUse.title": "Tölvunotkun",
  "settings.general.row.computerUse.description": "Leyfir umboðsmanninum að stjórna þessari tölvu beint — mús, lyklaborði og skjá — ekki bara innbyggða vafranum. Sjálfgefið á; hver aðgerð biður samt fyrst um staðfestingu. Krefst endurræsingar forritsins.",
  "settings.general.row.computerUse.descriptionOn": "Virkjað — endurræstu forritið svo tölvunotkun taki gildi.",
  "settings.general.row.computerUse.restart": "Endurræsa núna",
  "settings.providers.view.list": "Listasýn",
  "settings.providers.view.grid": "Töflusýn",
  "settings.mcp.add.button": "Bæta við tengingu",
  ...
  "settings.mcp.add.type.local": "Staðbundið (skipun)",
  "settings.mcp.add.type.remote": "Fjartengt (vefslóð)",
  "settings.mcp.add.field.command.label": "Skipun",
  "settings.mcp.add.field.command.placeholder": "npx -y @some/mcp-server",
  "settings.mcp.add.field.url.label": "Vefslóð",
  "settings.mcp.add.field.url.placeholder": "https://example.com/mcp",
  "settings.mcp.add.field.cwd.label": "Vinnumappa (valfrjálst)",
  "settings.mcp.add.field.cwd.placeholder": "Miðað við vinnusvæðið",
  "settings.mcp.add.field.env.label": "Umhverfisbreyta",
  "settings.mcp.add.field.headers.label": "Haus",
  "settings.mcp.add.field.timeout.label": "Tímamörk í ms (valfrjálst)",
  "settings.mcp.add.field.timeout.placeholder": "5000",
  "settings.mcp.add.toast.title": 'Tenging "{{name}}" bætt við',
  "settings.mcp.edit.title": "Breyta MCP tengingu",
  "settings.mcp.edit.toast.title": 'Tenging "{{name}}" uppfærð',
  "settings.mcp.remove.confirm.title": "Fjarlægja tengingu",
  "settings.mcp.remove.confirm.description": 'Fjarlægja "{{name}}" úr MCP þjónunum þínum? Þetta eyðir því úr stillingunum þínum, ekki bara aftengir það.',
  "settings.mcp.remove.button": "Fjarlægja",
  "settings.mcp.remove.toast.title": 'Tenging "{{name}}" fjarlægð',
  "settings.mcp.auth.connect.button": "Tengja",
  "settings.mcp.auth.needsClientRegistration.hint": "Þessi þjónn þarf forskráðan OAuth biðlara. Breyttu þessari tengingu og fylltu út OAuth biðlara auðkenni/leyndarmál.",
  "settings.mcp.add.field.oauthClientId.label": "OAuth biðlara auðkenni (valfrjálst)",
  "settings.mcp.add.field.oauthClientSecret.label": "OAuth biðlara leyndarmál (valfrjálst)",
  "settings.mcp.catalog.toggle": "Sýna verkfæri",
  "settings.mcp.catalog.empty": "Þessi þjónn birtir engin verkfæri, hvatningar eða úrræði.",
  "settings.mcp.catalog.tools": "Verkfæri ({{count}})",
  "settings.mcp.catalog.prompts": "Hvatningar ({{count}})",
  "settings.mcp.catalog.resources": "Úrræði ({{count}})",
  "settings.skills.title": "Hæfni",
  "settings.skills.empty": "Engin hæfni fannst",
  "settings.skills.sources.title": "Uppsprettur",
  "settings.skills.sources.claude.title": "Sjá Claude hæfni",
  "settings.skills.sources.claude.description": "Uppgötva hæfni frá ~/.claude/skills",
  "settings.skills.sources.codex.title": "Sjá Codex hæfni",
  "settings.skills.sources.codex.description": "Uppgötva hæfni frá ~/.codex/skills",
  "settings.skills.installed.title": "Uppgötvuð hæfni",
  "settings.externalAgents.title": "Umboðsmenn",
  "settings.externalAgents.refresh": "Endurhlaða",
  "settings.externalAgents.selectAll.title": "Velja alla uppgötvaða umboðsmenn",
  "settings.externalAgents.selectAll.description": "Setur upp batuta-cli hæfnina á hvern uppgötvaðan umboðsmann. Slökktu til að velja umboðsmenn hvern fyrir sig.",
  "settings.externalAgents.status.detected": "Uppgötvað á tengda þjóninum",
  "settings.externalAgents.status.notDetected": "Ekki uppgötvað — settu upp CLI og smelltu á Endurhlaða",
  "settings.marketplace.title": "Markaðstorg",
  "settings.marketplace.add.button": "Bæta við",
  "settings.marketplace.skills.add.title": "Bæta við hæfniuppsprettu",
  "settings.marketplace.skills.add.description": "Bættu við vefslóð sem þjónar opencode-samhæfu hæfniskjali.",
  "settings.marketplace.skills.add.placeholder": "https://example.com/.well-known/skills/",
  "settings.marketplace.mcp.add.title": "Bæta við MCP tengingu",
  "settings.marketplace.suggestions.title": "Tillögur",
  "settings.marketplace.suggestions.use": "Nota",
  "settings.marketplace.skills.suggestions.description": "Ekki staðfest á móti hæfniskjala sniði opencode — límdu inn raunverulega vefslóð skrárinnar til að staðfesta áður en nokkuð er flutt inn.",
  "settings.marketplace.catalogs.title": "Skrár",
  "settings.marketplace.catalogs.view": "Skoða",
  ...
  "settings.agentui.error.telegramNeedsProject": "Opnaðu þessa síðu úr tengdu verkefni til að gefa þessum umboðsmanni sinn eigin Telegram bot.",
  "settings.agentui.error.whatsappIncomplete": "Opnaðu þessa síðu úr tengdu verkefni og fylltu út öll nauðsynleg svæði fyrir valinn WhatsApp veitanda.",
  "settings.agentui.toast.saved": "Agent saved", // TODO: translate (auto-filled from en)
  "settings.agentui.dialog.addTitle": "Create agent", // TODO: translate (auto-filled from en)
  "settings.agentui.dialog.editTitle": "Edit agent", // TODO: translate (auto-filled from en)
  "settings.agentui.ai.title": "Búa til með gervigreind",
  "settings.agentui.ai.hint": "Lýstu umboðsmanninum sem þú vilt með þínum eigin orðum — nafn, persónuleiki og stillingar verða gerð hér að neðan til yfirferðar.",
  "settings.agentui.ai.placeholder": "t.d. Vinaleg móttökuritari tannlæknastofu sem svarar spurningum um tíma...",
  "settings.agentui.ai.generate": "Búa til",
  "settings.agentui.ai.generating": "Bý til…",
  "settings.agentui.ai.toast.generated": "Uppkast búið til — yfirfarðu áður en þú vistar",
...
"settings.agentui.field.whatsapp.tunnel.hint": "This server's URL is local (127.0.0.1/localhost) — the provider can't call it back to deliver messages. Start a public tunnel so it can.", // TODO: translate (auto-filled from en)
  ...
  "settings.agentui.field.telegramToken.placeholder": "Bot token (valfrjálst — skildu eftir autt til að deila alheims botnum)",
  "settings.agentui.field.telegramToken.hint": "Límdu token frá @BotFather til að gefa þessum umboðsmanni sinn eigin sérstakan Telegram bot. Skildu eftir autt til að nálgast hann í gegnum sameiginlega botinn í Stillingar → Samþættingar, með skipanaforskeyti hans.",
  "settings.agentui.field.whatsapp": "Svara á WhatsApp",
  "settings.agentui.field.whatsapp.hint": "Notar óopinbert WhatsApp API (í gegnum waconector) — veldu veitanda og fylltu út tengingarupplýsingar. Sjálfhýstir veitendur þurfa eigin netþjón/gám sem keyrir sérstaklega; þetta tengist bara við hann.",
  "settings.agentui.field.whatsapp.webhookUrl": "Webhook slóð — límdu hana inn í mælaborð veitanda",
  ...
  "settings.agentui.field.whatsapp.webhookAfterSave": "Webhook slóðin sem stilla þarf hjá veitanda birtist hér eftir að þú vistar.",
