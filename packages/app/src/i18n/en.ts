...
export const dict = {
  ...
  "batuta.form.field.worktree.label": "Use isolated worktree",
  "batuta.form.field.worktree.description": "Each worker gets its own git worktree, isolated from your main checkout.",
