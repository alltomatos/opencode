...
export const dict = {
  ...
  "command.settings.open.general": "Open settings — General",
  "command.settings.open.shortcuts": "Open settings — Shortcuts",
  "command.settings.open.servers": "Open settings — Servers",
  "command.settings.open.providers": "Open settings — Providers",
  "command.settings.open.models": "Open settings — Models",
  "command.settings.open.skills": "Open settings — Skills",
  "command.settings.open.mcp": "Open settings — MCP",
  "command.settings.open.breniac": "Open settings — Breniac",
  ...
  "breniac.state.idle": "Off",
  "breniac.state.listening": "Listening",
  "breniac.state.speaking": "Speaking",
  "breniac.state.off": "Off",
  "breniac.state.thinking": "Thinking",
  "breniac.state.responding": "Responding",
  "breniac.command.turnOn": "Turn Breniac on",
  "breniac.command.turnOff": "Turn Breniac off",
  "breniac.command.openProject": "Open project {{name}}",
  "breniac.command.openSession": 'Open session "{{title}}"',
  "breniac.command.openSession.untitled": "untitled",
  "breniac.command.toggle.description": "Stop listening, end the voice conversation (also matches: end, stop, that's all, close Breniac).",
  "breniac.screen.settingsTab": "Settings dialog open, on the \"{{tab}}\" tab.",
  ...
  "breniac.speak.commandDone": "Done: {{title}}",
  "breniac.speak.noProject": "Open a project first so I know where to send that.",
  "breniac.speak.promptReady": "Your prompt is ready — review and send it whenever you want.",
  "breniac.memory.confirmGlobal": "This looks relevant beyond this project ({{reason}}). Save it to global memory too?",
  ...
  "settings.breniac.toast.saved": "Breniac settings saved",
  "settings.breniac.quickFill.button": "Use recommended Omniroute models",
  "settings.breniac.recommended.title": "Recommended Omniroute models",
  "settings.breniac.recommended.notConnected": "Omniroute isn't connected yet — connect it first to pick from its live catalog.",
  "settings.breniac.recommended.noneFound": "None of the known models for this field were found in the catalog.",
  ...
  "settings.breniac.field.audioModel.description": "Model used for the live voice conversation (input and output audio).",
  "settings.breniac.field.transcriptionModel.title": "Transcription model",
  "settings.breniac.field.transcriptionModel.description": "Model used to transcribe your speech (STT).",
  "settings.breniac.field.memoryModel.title": "Memory model",
  "settings.breniac.field.memoryModel.description": "Model used to summarize a voice session into the memory files.",
