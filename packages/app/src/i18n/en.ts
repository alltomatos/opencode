...
export const dict = {
  ...
  "settings.breniac.quickFill.toast.done": "Filled in the validated Omniroute models",
  "settings.breniac.quickFill.toast.partial.title": "Some models weren't found",
  "settings.breniac.quickFill.toast.partial.description": "Missing from the Omniroute catalog: {fields}. Fill those in manually.",
