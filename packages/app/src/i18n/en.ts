...
export const dict = {
  ...
  "settings.mcp.add.known.localHint": "This connector runs locally. Build it first (npm install && npm run build), then set the command's working directory and the MAIL_MCP_ACCOUNTS_PATH environment variable below to your accounts.json file.",
