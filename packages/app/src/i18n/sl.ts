export const dict = {
  ...
  "settings.agentui.ai.title": "Ustvari z UI",
  "settings.agentui.ai.hint": "Opišite agenta, ki ga želite, s svojimi besedami — ime, osebnost in nastavitve bodo pripravljeni spodaj za pregled.",
  "settings.agentui.ai.placeholder": "npr. Prijazna receptorka zobozdravstvene ordinacije, ki odgovarja na vprašanja o terminih...",
  "settings.agentui.ai.generate": "Ustvari",
  "settings.agentui.ai.generating": "Ustvarjanje…",
  "settings.agentui.ai.toast.generated": "Osnutek ustvarjen — preglejte pred shranjevanjem",
