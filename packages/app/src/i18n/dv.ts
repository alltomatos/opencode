export const dict = {
  ...
  "session.question.pending.many": "{{count}} pending questions",
  ...
  "session.followupDock.summary.many": "{{count}} queued messages",
  ...
  "session.revertDock.summary.many": "{{count}} rolled back messages",
