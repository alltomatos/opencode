export const dict = {
  ...
  "settings.agentui.ai.title": "Створити за допомогою ШІ",
  "settings.agentui.ai.hint": "Опишіть потрібного агента власними словами — ім'я, характер і налаштування буде підготовлено нижче для перегляду.",
  "settings.agentui.ai.placeholder": "напр. Привітна адміністраторка стоматологічної клініки, яка відповідає на запитання про запис...",
  "settings.agentui.ai.generate": "Згенерувати",
  "settings.agentui.ai.generating": "Генерування…",
  "settings.agentui.ai.toast.generated": "Чернетку створено — перегляньте перед збереженням",
