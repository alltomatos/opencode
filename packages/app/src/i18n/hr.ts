...
export const dict = {
  ...
  "settings.agentui.error.telegramNeedsProject": "Otvorite ovu stranicu iz povezanog projekta kako biste ovom agentu dali vlastiti Telegram bot.",
  "settings.agentui.error.whatsappIncomplete": "Otvorite ovu stranicu iz povezanog projekta i ispunite sva obavezna polja za odabranog WhatsApp pružatelja.",
  "settings.agentui.toast.saved": "Agent saved", // TODO: translate (auto-filled from en)
  "settings.agentui.dialog.addTitle": "Create agent", // TODO: translate (auto-filled from en)
  "settings.agentui.dialog.editTitle": "Edit agent", // TODO: translate (auto-filled from en)
  "settings.agentui.ai.title": "Izradi pomoću AI-ja",
  "settings.agentui.ai.hint": "Opišite agenta kojeg želite svojim riječima — ime, osobnost i postavke izradit će se u nastavku na pregled.",
  "settings.agentui.ai.placeholder": "npr. Ljubazna recepcionerka zubne ordinacije koja odgovara na pitanja o terminima...",
  "settings.agentui.ai.generate": "Generiraj",
  "settings.agentui.ai.generating": "Generiranje…",
  "settings.agentui.ai.toast.generated": "Nacrt je generiran — pregledajte prije spremanja",
...
"settings.agentui.field.whatsapp.tunnel.hint": "This server's URL is local (127.0.0.1/localhost) — the provider can't call it back to deliver messages. Start a public tunnel so it can.", // TODO: translate (auto-filled from en)
  ...
  "settings.agentui.field.telegramToken.placeholder": "Token bota (neobavezno — ostavite prazno za dijeljenje globalnog bota)",
  "settings.agentui.field.telegramToken.hint": "Zalijepite token od @BotFather kako biste ovom agentu dali vlastiti namjenski Telegram bot. Ostavite prazno za pristup putem zajedničkog bota u Postavke → Integracije, koristeći njegov prefiks naredbe.",
