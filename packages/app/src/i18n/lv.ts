export const dict = {
  ...
  "settings.agentui.ai.title": "Izveidot ar MI",
  "settings.agentui.ai.hint": "Aprakstiet vēlamo aģentu savos vārdos — nosaukums, personība un iestatījumi tiks sagatavoti zemāk pārskatīšanai.",
  "settings.agentui.ai.placeholder": "piemēram: Draudzīga zobārstniecības klīnikas administratore, kas atbild uz jautājumiem par pierakstiem...",
  "settings.agentui.ai.generate": "Ģenerēt",
  "settings.agentui.ai.generating": "Ģenerē…",
  "settings.agentui.ai.toast.generated": "Melnraksts izveidots — pārskatiet pirms saglabāšanas",
