export const dict = {
  ...
  "settings.agentui.ai.title": "AI bilen dörediň",
  "settings.agentui.ai.hint": "Isleýän agentiňizi öz sözleriňiz bilen beýan ediň — ady, häsiýeti we sazlamalary aşakda seretmek üçin taýýarlanar.",
  "settings.agentui.ai.placeholder": "meselem: Duşuşyk soraglaryna jogap berýän mähirli dişçi kliniginiň kabul edijisi...",
  "settings.agentui.ai.generate": "Döret",
  "settings.agentui.ai.generating": "Döredilýär…",
  "settings.agentui.ai.toast.generated": "Taslama döredildi — ýatda saklamazdan öň seredip görüň",
