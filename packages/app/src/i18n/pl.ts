export const dict = {
  ...
  "settings.agentui.error.telegramNeedsProject": "Otwórz tę stronę z połączonego projektu, aby nadać temu agentowi własnego bota Telegram.",
  "settings.agentui.error.whatsappIncomplete": "Otwórz tę stronę z połączonego projektu i wypełnij wszystkie wymagane pola dla wybranego dostawcy WhatsApp.",
  "settings.agentui.toast.saved": "Agent saved", // TODO: translate (auto-filled from en)
  "settings.agentui.dialog.addTitle": "Create agent", // TODO: translate (auto-filled from en)
  "settings.agentui.dialog.editTitle": "Edit agent", // TODO: translate (auto-filled from en)
  "settings.agentui.ai.title": "Utwórz z AI",
  "settings.agentui.ai.hint": "Opisz własnymi słowami agenta, którego chcesz — nazwa, osobowość i ustawienia zostaną przygotowane poniżej do przeglądu.",
  "settings.agentui.ai.placeholder": "np. Przyjazna recepcjonistka gabinetu stomatologicznego odpowiadająca na pytania dotyczące wizyt...",
  "settings.agentui.ai.generate": "Generuj",
  "settings.agentui.ai.generating": "Generowanie…",
  "settings.agentui.ai.toast.generated": "Szkic wygenerowany — sprawdź przed zapisaniem",
...
"settings.agentui.field.whatsapp.tunnel.hint": "This server's URL is local (127.0.0.1/localhost) — the provider can't call it back to deliver messages. Start a public tunnel so it can.", // TODO: translate (auto-filled from en)
  ...
  "settings.agentui.field.telegramToken.placeholder": "Token bota (opcjonalnie — zostaw puste, aby współdzielić globalnego bota)",
  "settings.agentui.field.telegramToken.hint": "Wklej token od @BotFather, aby nadać temu agentowi własnego dedykowanego bota Telegram. Zostaw puste, aby uzyskać dostęp przez współdzielonego bota w Ustawienia → Integracje, używając jego prefiksu komendy.",
