export const dict = {
  ...
  "dialog.provider.omniroute.note": "Use sua própria URL de gateway e chave, todos os modelos são importados automaticamente",
  ...
  "prompt.mode.select.title": "Selecionar modo",
  "prompt.mode.auto.label": "Automático",
  "prompt.mode.auto.description": "Gerencia as decisões de permissão automaticamente",
  "prompt.mode.manual.label": "Manual",
  "prompt.mode.manual.description": "Sempre perguntar antes de fazer alterações",
  "prompt.mode.edits.label": "Aceitar edições",
  "prompt.mode.edits.description": "Aceitar automaticamente todas as edições de arquivo",
  "prompt.mode.plan.label": "Planejar",
  ...
  "provider.action.refreshToken": "Re-token",
  "provider.action.refreshToken.success": "Token atualizado com sucesso",
  "provider.authError.toast.title": "Verificação de conta necessária",
  "provider.authError.toast.description": "Sua conta precisa de reautenticação ou verificação de segurança para continuar.",
  "provider.authError.action.reconnect": "Fazer login / Reconectar conta",
  ...
  "provider.omniroute.description": "Informe a URL do gateway e a API key do Omniroute. Todos os modelos disponíveis são importados automaticamente e organizados por categoria.",
  "provider.omniroute.importing": "Importando modelos...",
  "provider.omniroute.toast.imported": "{{count}} modelos importados",
  "provider.omniroute.toast.importedFiltered": "{{count}} modelos importados ({{skipped}} ignorados)",
  "provider.omniroute.field.combosOnly.label": "Importar apenas combos",
  "provider.omniroute.field.combosOnly.description": "Ignora entradas simples de provedor/modelo e importa só os modelos combo",
  ...
  "sshTunnel.server.add": "Adicionar túnel SSH",
  "sshTunnel.server.label": "SSH",
  "sshTunnel.server.menu.label": "Túnel SSH",
  "sshTunnel.server.retryStart": "Tentar reconectar",
  "sshTunnel.server.viewLogs": "Ver logs / Reconectar",
  "sshTunnel.server.update": "Atualizar OpenCode",
  "sshTunnel.server.qrCode": "Ver QR code",
  "sshTunnel.progress.title": "Status da Conexão SSH",
  "sshTunnel.progress.connecting": "Conectando ao servidor...",
  "sshTunnel.progress.step.testSsh": "Autenticação SSH",
  "sshTunnel.progress.step.checkInstall": "Verificar / Instalar OpenCode",
  "sshTunnel.progress.step.startService": "Iniciar Serviço Remoto",
  "sshTunnel.progress.step.tunnel": "Estabelecer Túnel Local",
  "sshTunnel.progress.logs": "Logs em Tempo Real",
  "sshTunnel.progress.retry": "Tentar Novamente",
  "sshTunnel.progress.close": "Fechar",
  "sshTunnel.progress.done": "Conectado",
  "sshTunnel.progress.failed": "Falha na Conexão",
  "sshTunnel.add.title": "Adicionar túnel SSH",
  "sshTunnel.add.sectionSsh": "1. Acesso SSH à VPS",
  "sshTunnel.add.sectionOpencode": "2. Servidor OpenCode Remoto",
  "sshTunnel.add.autoSetupHint": "Instala e executa o servidor automaticamente na VPS caso necessário",
  "sshTunnel.add.host": "Host da VPS",
  "sshTunnel.add.hostPlaceholder": "ex: 147.93.176.59 ou meuservidor.com",
  "sshTunnel.add.sshPort": "Porta SSH",
  "sshTunnel.add.sshUsername": "Usuário SSH",
  "sshTunnel.add.key": "Chave SSH",
  "sshTunnel.add.keyDefault": "Padrão (agente SSH)",
  "sshTunnel.add.cert": "Certificado SSH",
  "sshTunnel.add.certDefault": "Padrão (agente SSH)",
  "sshTunnel.add.sshPassword": "Senha SSH",
  "sshTunnel.add.label": "Nome (opcional)",
  "sshTunnel.add.labelPlaceholder": "ex: omniroute",
  "sshTunnel.add.remotePort": "Porta do opencode na VPS",
  "sshTunnel.add.button": "Adicionar túnel",
  "sshTunnel.add.autoSetup": "Instalar opencode automaticamente no servidor",
  "sshTunnel.add.error.hostRequired": "Informe o host da VPS",
  "tailscale.server.add": "Adicionar túnel Tailscale",
  "tailscale.add.title": "Adicionar túnel Tailscale",
  "tailscale.add.host": "IP ou hostname Tailscale",
  "tailscale.add.hostPlaceholder": "ex: 100.86.156.0 ou maquina.tailnet.ts.net",
  "tailscale.add.error.notRunning": "Tailscale não detectado nesta máquina. Instale e conecte o Tailscale antes de adicionar este tipo de servidor.",
  "tailscale.add.error.unreachable": "Não foi possível conectar nesse endereço. Confirme que a VPS também está no Tailscale e que o opencode está rodando lá.",
  ...
  "context.stats.workTime": "Tempo de trabalho",
  ...
  "home.server.type.http": "http",
  "home.server.type.https": "https",
  "home.server.type.local": "local",
  "home.server.type.wsl": "wsl",
  "home.server.type.ssh": "ssh",
  "home.server.type.tailscale": "tailscale",
  ...
  "session.git.switchBranch": "Trocar branch",
  "session.git.branches": "Branches Git",
  "session.git.checkoutFailed": "Falha ao trocar de branch",
  "session.git.switchConfirmTitle": "Trocar de branch?",
  "session.git.switchConfirmDesc": "Existem alterações não commitadas. Trocar para '{{branch}}' pode falhar ou arrastar essas edições para lá.",
  "session.git.switchConfirmButton": "Trocar assim mesmo",
  "session.git.activeSessionWarn": "Sessão rodando nesta branch",
  "session.new.worktree.isolatedToggle": "Criar em worktree isolada",
  ...
  "browser.panel.toggle": "Navegador",
  "browser.panel.back": "Voltar",
  "browser.panel.forward": "Avançar",
  "browser.panel.reload": "Recarregar",
  "browser.panel.address.placeholder": "Digite uma URL",
  ...
  "batuta.list.title": "Atividades",
  "batuta.list.create": "Nova atividade",
  "batuta.list.empty": "Nenhuma atividade ainda. Crie uma para começar.",
  ...
  "settings.agentui.error.telegramNeedsProject": "Abra esta página a partir de um projeto conectado para dar um bot próprio do Telegram a este agente.",
  "settings.agentui.error.whatsappIncomplete": "Abra esta página a partir de um projeto conectado e preencha todos os campos obrigatórios do provedor de WhatsApp selecionado.",
  "settings.agentui.toast.saved": "Agente salvo",
  "settings.agentui.dialog.addTitle": "Criar agente",
  "settings.agentui.dialog.editTitle": "Editar agente",
  "settings.agentui.ai.title": "Criar com IA",
  "settings.agentui.ai.hint": "Descreva o agente que você quer com suas próprias palavras — nome, personalidade e configurações são pré-preenchidos abaixo para você revisar.",
  "settings.agentui.ai.placeholder": "ex.: Uma recepcionista simpática de consultório odontológico que responde dúvidas sobre agendamento...",
  "settings.agentui.ai.generate": "Gerar",
  "settings.agentui.ai.generating": "Gerando…",
  "settings.agentui.ai.toast.generated": "Rascunho gerado — revise antes de salvar",
  ...
  "settings.agentui.field.whatsapp": "Responder no WhatsApp",
  "settings.agentui.tabs.general": "Geral",
  "settings.agentui.tabs.channels": "Canais",
  "settings.agentui.tabs.tools": "Ferramentas",
  "settings.agentui.tabs.knowledge": "Conhecimento",
  "settings.agentui.tabs.audit": "Auditoria",
  "settings.agentui.audit.title": "Histórico de mensagens",
  "settings.agentui.audit.refresh": "Atualizar",
  "settings.agentui.audit.loading": "Carregando…",
  "settings.agentui.audit.needsSave": "Salve o agente primeiro para ver o histórico de mensagens.",
  "settings.agentui.audit.empty": "Nenhuma mensagem registrada ainda.",
  "settings.agentui.audit.blocked": "Bloqueada",
  "settings.agentui.audit.incoming": "Recebida",
  "settings.agentui.audit.outgoing": "Respondida",
  "settings.agentui.field.mcpServers": "Servidores MCP",
  ...
  "settings.agentui.field.whatsapp.izapiaSessions.loading": "Buscando…",
  "settings.agentui.field.whatsapp.izapiaSessions.empty": "Nenhuma sessão encontrada para essa API key.",
  "settings.agentui.field.whatsapp.izapiaGroups.label": "Grupos",
  "settings.agentui.field.whatsapp.izapiaGroups.hint": "Mensagens diretas são sempre respondidas. Marque os grupos em que o agente também deve responder — grupos desmarcados são ignorados.",
  "settings.agentui.field.whatsapp.izapiaGroups.fetch": "Buscar grupos",
  "settings.agentui.field.whatsapp.izapiaGroups.loading": "Buscando…",
  "settings.agentui.field.whatsapp.izapiaGroups.empty": "Nenhum grupo encontrado para as sessões selecionadas.",
  "settings.agentui.field.whatsapp.tunnel.tailscale.hint": "Opção mais simples se você já tem o Tailscale rodando nesta máquina e no servidor do provedor: use o IP Tailscale desta máquina direto, sem precisar de túnel.",
  "settings.agentui.field.whatsapp.tunnel.tailscale.use": "Usar IP Tailscale",
  "settings.agentui.field.whatsapp.tunnel.tailscale.detecting": "Detectando…",
  "settings.agentui.field.whatsapp.tunnel.tailscale.notFound": "Nenhum IP Tailscale encontrado. O Tailscale está instalado e rodando?",
  "settings.agentui.field.whatsapp.tunnel.hint": "A URL deste servidor é local (127.0.0.1/localhost) — o provedor não consegue chamá-la de volta para entregar mensagens. Inicie um túnel público para resolver isso.",
  "settings.agentui.field.whatsapp.tunnel.start": "Iniciar túnel público",
  "settings.agentui.field.whatsapp.tunnel.starting": "Iniciando…",
  "settings.agentui.field.whatsapp.tunnel.active": "Túnel público ativo: {{url}} — a URL do webhook abaixo já está usando ele.",
  ...
  "settings.agentui.field.guardrailsLevel": "Nível de guardrails",
  "settings.agentui.guardrails.basic": "Básico",
  "settings.agentui.guardrails.strict": "Rígido",
  "settings.agentui.field.ragSources": "Fontes de conhecimento",
  "settings.agentui.rag.label": "Rótulo",
  "settings.agentui.rag.value": "Texto ou URL",
  "settings.agentui.rag.add": "Adicionar fonte",
  "settings.agentui.rag.note": "Upload de arquivo e busca de verdade chegam numa fase futura — por enquanto isso só fica salvo como está.",
  "settings.agentui.field.enabled": "Ativado",
  "settings.agentui.enable": "Ativar agente",
  "settings.agentui.disable": "Desativar agente",
  "settings.agentui.sandbox.open": "Testar",
  "settings.agentui.sandbox.title": "Testar {{name}}",
  "settings.agentui.sandbox.empty": "Envie uma mensagem para testar este agente — mesma personalidade, modelo e guardrails que ele usa de verdade, numa conversa de teste privada.",
  "settings.agentui.sandbox.placeholder": "Digite uma mensagem...",
  "settings.agentui.sandbox.send": "Enviar",
  "settings.agentui.sandbox.reset": "Nova conversa",
  "settings.agentui.sandbox.noDirectory": "Abra um projeto primeiro para testar este agente.",
  "settings.agentui.form.title.create": "Novo agente",
  "settings.agentui.form.title.edit": "Editar agente",
  "settings.agentui.form.testHint": "Salve o agente primeiro para testá-lo.",
  ...
  "settings.combos.filter.requireVision": "Exigir suporte a Visão / Imagens",
  "settings.combos.filter.requirePdf": "Exigir suporte a Documentos / PDF",
  "settings.combos.field.tokensPerMinute": "Tokens / minuto (opcional)",
  "settings.combos.ai.title": "Assistente Especialista em Combos",
  "settings.combos.ai.hint": "Descreva o que você precisa (ex.: foco em codificação pesada com fallback rápido, economia de tokens, ou alta resiliência). O assistente usará os provedores e modelos já conectados e montará a melhor cadeia de failover para você.",
  "settings.combos.ai.placeholder": "ex.: Combo para programação TypeScript pesada usando modelos principais com fallback automático para modelos mais leves e rápidos...",
  "settings.combos.ai.generate": "Gerar recomendação",
  "settings.combos.ai.generating": "Analisando provedores e gerando…",
  "settings.combos.ai.toast.generated": "Combo recomendado gerado — revise antes de salvar",
  ...
  "batuta.form.field.name.placeholder": "ex.: Refatorar módulo de pagamentos",
  "batuta.form.field.goal.label": "Objetivo",
  "batuta.form.field.goal.placeholder": "O que o orquestrador deve realizar?",
  "batuta.form.field.orchestrator.label": "Modelo do orquestrador",
  ...
  "batuta.form.field.directory.description": "A pasta onde o orquestrador e os workers dessa atividade vão rodar.",
  "batuta.form.field.directory.error.required": "Escolha ou adicione uma pasta de projeto.",
  ...
  "batuta.remove.confirm.title": "Remover atividade?",
  "batuta.remove.confirm.description": "\"{{name}}\" será removida permanentemente.",
  "batuta.list.viewLive": "Ver ao vivo",
  "batuta.panel.title": "Atividade ao vivo",
  "batuta.panel.empty": "Essa atividade não está em execução. Inicie-a na lista de atividades pra vê-la ao vivo.",
  "batuta.panel.status.idle": "Ociosa",
  "batuta.panel.status.busy": "Trabalhando",
  "batuta.panel.status.retry": "Tentando novamente",
  "batuta.panel.architect.working": "O Arquiteto está estudando o projeto e preparando os documentos...",
  "batuta.panel.architect.open": "Abrir sessão do arquiteto",
  "batuta.panel.pipeline.title": "Pipeline",
  "batuta.panel.tab.graph": "Grafo",
  "batuta.panel.tab.pipeline": "Pipeline",
  "batuta.panel.tab.kanban": "Kanban",
  "batuta.pipeline.kanban.pending": "Pendente",
  "batuta.pipeline.kanban.inProgress": "Em andamento",
  "batuta.pipeline.kanban.completed": "Concluído",
  "batuta.pipeline.kanban.empty": "Nada por aqui ainda.",
  "batuta.pipeline.phase.planning": "Planejamento",
  "batuta.pipeline.phase.development": "Desenvolvimento",
  "batuta.pipeline.phase.testing": "Testes",
  "batuta.pipeline.phase.quality": "Qualidade",
  "batuta.pipeline.phase.delivery": "Entrega",
  "batuta.pipeline.definition.missing":
    "Nenhum fluxo de pipeline definido ainda — o Arquiteto vai defini-lo enquanto estuda o projeto. As issues aparecem agrupadas assim que isso acontecer.",
  "batuta.pipeline.editor.open": "Editar fluxo",
  "batuta.pipeline.editor.title": "Fluxo do pipeline",
  "batuta.pipeline.editor.description":
    "Compartilhado entre todas as atividades deste projeto (docs/batuta-pipeline.md). Defina fases como headings \"## Nome da fase\", cada uma seguida de uma lista de slugs de skill (ex: \"- tdd\"). O Orquestrador relê isso periodicamente, então edições valem mesmo com ele já rodando.",
  "batuta.pipeline.editor.save": "Salvar",
  "batuta.pipeline.editor.tab.editor": "Texto",
  "batuta.pipeline.editor.tab.chat": "Chat",
  "batuta.pipeline.chat.description":
    "Converse com uma sessão restrita a ler/escrever apenas docs/batuta-pipeline.md — ela não aparece na lista de sessões e não consegue mexer em mais nada.",
  "batuta.pipeline.chat.placeholder": "Descreva a mudança que você quer no fluxo do pipeline...",
  "batuta.pipeline.chat.send": "Enviar",
  "batuta.pipeline.chat.empty": "Nenhuma mensagem ainda — envie uma para começar a ajustar o fluxo.",
  "batuta.pipeline.chat.starting": "Iniciando o chat...",
  "batuta.pipeline.stage.architecture": "Arquitetura",
  "batuta.pipeline.stage.architecture.detail":
    "O Arquiteto estudou o projeto em relação ao objetivo da atividade, criou/editou os documentos (PRD, DER), usou /grill-me pra esclarecer ambiguidades, e fatiou o trabalho em issues.",
  "batuta.pipeline.stage.orchestration": "Orquestração",
  "batuta.pipeline.stage.orchestration.detail":
    "O Orquestrador recebeu o handoff do Arquiteto (documentos + issues) e começou a despachar cada issue pro worker ou skill certos.",
  "batuta.panel.detail.open": "Abrir sessão completa",
  "batuta.panel.detail.empty": "Nada ainda — aguardando esse agente começar a trabalhar.",
  "batuta.panel.ready.title": "Arquiteto terminou — revise o plano antes de iniciar",
  "batuta.panel.ready.dispatch": "Iniciar atividade",
  "batuta.form.field.branch.label": "Branch",
  "batuta.form.field.branch.description":
    "Branch em que o checkout principal vai ficar quando a atividade iniciar. Deixe a branch detectada como está, ou digite um nome novo pra criar e trocar pra ela.",
  "batuta.form.field.branch.placeholder": "Selecione uma branch",
  "batuta.form.field.branch.newPlaceholder": "Nome da nova branch",
  "batuta.form.field.branch.create": "Nova branch",
  ...
  "settings.footer.credit": "Por: Alltomatos",
  "settings.title": "Configurações",
  "settings.section.desktop": "Desktop",
  "settings.section.server": "Servidor",
  "settings.section.customize": "Personalizar",
  ...
  "settings.general.section.general": "Geral",
  ...
  "settings.providers.quota.dialogTitle": "Cota da conta: {{account}}",
  "settings.providers.quota.overall": "Cota geral disponível",
  "settings.providers.quota.modelsDetail": "Detalhamento por Modelo",
  "settings.providers.quota.noBuckets": "Nenhum balde de cota detalhado retornado pela API.",
  "settings.providers.quota.resetsAt": "Renova às {{time}}",
  "settings.providers.quota.tier.pro": "Pro",
  "settings.providers.quota.tier.free": "Gratuito",
  "settings.providers.quota.buttonTooltip": "Ver cota e plano da conta",
  "settings.providers.view.list": "Visualização em lista",
  "settings.providers.view.grid": "Visualização em grade",
  ...
  "settings.memory.quickFill.button": "Ver sugestões",
  "settings.memory.toast.saved": "Configurações de memória salvas",
  "settings.memory.recommended.title": "Modelos de memória recomendados",
  "settings.memory.recommended.notConnected": "Conecte o Omniroute para ver modelos recomendados.",
  "settings.memory.recommended.noneFound": "Nenhum modelo recomendado encontrado no catálogo deste provider.",
  "settings.memory.recommended.apply": "Aplicar",
  "settings.memory.recommended.tier.ok": "pago, sem limite conhecido",
  "settings.memory.recommended.tier.limited": "grátis, com limite de uso",
  "dialog.memory.title": "Memória",
  "dialog.memory.subtitle.project": "Memória deste projeto",
  "dialog.memory.subtitle.global": "Memória global (compartilhada entre projetos)",
  "dialog.memory.tab.project": "Projeto",
  "dialog.memory.tab.global": "Global",
  "dialog.memory.search.placeholder": "Buscar na memória (decisões, pendências, termos)...",
  "dialog.memory.copy.button": "Copiar",
  "dialog.memory.copy.success": "Copiado para a área de transferência",
  "dialog.memory.empty.search.title": "Nenhum resultado encontrado",
  "dialog.memory.empty.search.description": "Tente buscar com outros termos.",
  "dialog.memory.empty.project.title": "Nenhuma memória de projeto",
  "dialog.memory.empty.project.description":
    "Decisões e fatos aprendidos durante as sessões deste projeto aparecem aqui, ou você pode adicionar anotações manualmente.",
  "dialog.memory.empty.global.title": "Nenhuma memória global",
  "dialog.memory.empty.global.description":
    "Fatos e preferências globais são compartilhados com todos os projetos e sessões neste servidor.",
  "dialog.memory.addNote.placeholder": "Adicionar anotação na memória...",
  "dialog.memory.addNote.button": "Salvar nota",
  "dialog.memory.promote.button": "Promover para Global",
  "dialog.memory.promote.success": "Memória promovida para o escopo global.",
  "dialog.memory.forgetProject.button": "Esquecer projeto",
  "dialog.memory.forgetProject.confirm":
    "Deseja apagar todas as memórias salvas para este projeto? A memória global não será afetada.",
  "dialog.memory.forgetProject.success": "Memória do projeto apagada.",
  "dialog.memory.backfill.button": "Sintetizar sessões passadas",
  "dialog.memory.backfill.running": "Sintetizando...",
  "dialog.memory.backfill.success": "Varredura concluída: {{count}} de {{total}} sessões sintetizadas.",
  "session.header.memory.tooltip": "Memória",
  "settings.integrations.title": "Integrações",
  "settings.integrations.section.channels": "Canais",
  "settings.integrations.telegram.title": "Telegram",
  "settings.integrations.telegram.description":
    "Conecte um bot do Telegram pra conversar com o opencode direto do Telegram. Crie um bot com o @BotFather, copie o token que ele te der, e cole aqui.",
  "settings.integrations.telegram.field.token.placeholder": "Token do bot",
  "settings.integrations.telegram.error.required": "Informe o token do bot",
  "settings.integrations.telegram.toast.connected.title": "Bot do Telegram conectado",
  "settings.mcp.description": "Configurações de MCP estarão disponíveis aqui.",
  "settings.mcp.add.button": "Adicionar conector",
  ...
  "settings.mcp.add.type.local": "Local (comando)",
  "settings.mcp.add.type.remote": "Remoto (URL)",
  "settings.mcp.add.field.command.label": "Comando",
  "settings.mcp.add.field.command.placeholder": "npx -y @algum/mcp-server",
  "settings.mcp.add.field.url.label": "URL",
  "settings.mcp.add.field.url.placeholder": "https://exemplo.com/mcp",
  "settings.mcp.add.field.cwd.label": "Diretório de trabalho (opcional)",
  "settings.mcp.add.field.cwd.placeholder": "Relativo ao workspace",
  "settings.mcp.add.field.env.label": "Variável de ambiente",
  "settings.mcp.add.field.headers.label": "Cabeçalho",
  "settings.mcp.add.field.timeout.label": "Timeout em ms (opcional)",
  "settings.mcp.add.field.timeout.placeholder": "5000",
  "settings.mcp.add.toast.title": "Conector \"{{name}}\" adicionado",
  "settings.mcp.edit.title": "Editar conector MCP",
  "settings.mcp.edit.toast.title": "Conector \"{{name}}\" atualizado",
  "settings.mcp.remove.confirm.title": "Remover conector",
  ...
  "settings.mcp.catalog.toggle": "Ver ferramentas",
  "settings.mcp.catalog.empty": "Esse servidor não expõe nenhuma ferramenta, prompt ou resource.",
  "settings.mcp.catalog.tools": "Ferramentas ({{count}})",
  ...
  "settings.skills.sources.title": "Fontes",
  "settings.skills.sources.claude.title": "Enxergar skills do Claude",
  "settings.skills.sources.claude.description": "Descobre skills em ~/.claude/skills",
  ...
  "settings.marketplace.skills.add.description": "Adicione uma URL que sirva um manifesto de skills compatível com o opencode.",
  "settings.marketplace.skills.add.placeholder": "https://exemplo.com/.well-known/skills/",
  "settings.marketplace.mcp.add.title": "Adicionar conector MCP",
  "settings.marketplace.suggestions.title": "Sugestões",
  "settings.marketplace.suggestions.use": "Usar",
  "settings.marketplace.skills.suggestions.description": "Não verificado contra o formato de manifesto de skills do opencode — cole a URL real do catálogo pra confirmar antes de importar qualquer coisa.",
  "settings.marketplace.catalogs.title": "Catálogos",
  "settings.marketplace.catalogs.view": "Ver",
  ...
  "server.remove.title": "Remover servidor",
  "server.remove.confirm": 'Remover o servidor "{{name}}"? Os projetos e sessões dele deixarão de aparecer aqui.',
  "server.remove.button": "Remover servidor",
  ...
  "command.stats.open": "Abrir KPIs e Estatísticas de Uso",

  "stats.title": "KPIs & Estatísticas de Tokens",
  "stats.description": "Visão geral do volume gerado de tokens, proporção de entrada/saída, raciocínio, cache e custos.",
  "stats.refresh": "Atualizar",
  "stats.filter.range": "Período",
  "stats.filter.today": "Hoje",
  "stats.filter.7d": "7 Dias",
  "stats.filter.30d": "30 Dias",
  "stats.filter.all": "Tudo",
  "stats.filter.project": "Projeto",
  "stats.filter.project.all": "Todos os projetos",
  "stats.kpi.totalTokens": "Total de Tokens",
  "stats.kpi.totalTokens.sub": "Entrada + Saída + Raciocínio + Cache",
  "stats.kpi.outputTokens": "Tokens de Saída",
  "stats.kpi.outputTokens.sub": "Tokens de conclusão gerados",
  "stats.kpi.inputTokens": "Tokens de Entrada",
  "stats.kpi.inputTokens.sub": "Prompts e contexto enviados",
  "stats.kpi.reasoningTokens": "Tokens de Raciocínio",
  "stats.kpi.reasoningTokens.sub": "Pensamento / Reasoning do modelo",
  "stats.kpi.cacheTokens": "Cache (Leitura / Escrita)",
  "stats.kpi.cacheTokens.sub": "Eficiência de acerto em cache",
  "stats.kpi.totalCost": "Custo Estimado",
  "stats.kpi.totalCost.sub": "Gasto total com APIs",
  "stats.kpi.totalDuration": "Tempo de Trabalho",
  "stats.kpi.totalDuration.sub": "Tempo total de trabalho do agente",
  "stats.kpi.longestDuration": "Pedido Mais Longo",
  "stats.kpi.longestDuration.sub": "Tempo recorde num único pedido",
  "stats.kpi.totalSessions": "Total de Sessões",
  ...
  "stats.distribution.reasoning": "Raciocínio",
  "stats.distribution.cache": "Cache Lido",
  "stats.breakdown.models": "Consumo por Modelo",
  "stats.breakdown.agents": "Consumo por Agente",
  "stats.breakdown.projects": "Consumo por Projeto",
  "stats.breakdown.col.name": "Nome",
  "stats.breakdown.col.tokens": "Tokens",
  "stats.breakdown.col.output": "Saída",
  "stats.breakdown.col.reasoning": "Raciocínio",
  "stats.breakdown.col.cost": "Custo",
  "stats.breakdown.col.sessions": "Sessões",
  "stats.breakdown.col.share": "Proporção",
  "stats.activity.title": "Consumo Diário de Tokens",
  "stats.sessions.title": "Sessões Recentes",
  "stats.sessions.empty": "Nenhuma sessão encontrada para este período",
  "stats.sessions.col.title": "Sessão",
  "stats.sessions.col.model": "Modelo",
  "stats.sessions.col.tokens": "Tokens",
  "stats.sessions.col.duration": "Tempo de Trabalho",
  "stats.sessions.col.cost": "Custo",
  "stats.sessions.col.time": "Data",
  "stats.sessions.open": "Abrir",
}
