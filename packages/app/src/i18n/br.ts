export const dict = {
  ...
  "settings.breniac.quickFill.toast.done": "Preenchido com os modelos do Omniroute já validados",
  "settings.breniac.quickFill.toast.partial.title": "Alguns modelos não foram encontrados",
  "settings.breniac.quickFill.toast.partial.description": "Faltando no catálogo do Omniroute: {fields}. Preencha esses manualmente.",
