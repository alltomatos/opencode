export const dict = {
  ...
  "command.settings.open.general": "Abrir configurações — Geral",
  "command.settings.open.shortcuts": "Abrir configurações — Atalhos",
  "command.settings.open.servers": "Abrir configurações — Servidores",
  "command.settings.open.providers": "Abrir configurações — Provedores",
  "command.settings.open.models": "Abrir configurações — Modelos",
  "command.settings.open.skills": "Abrir configurações — Skills",
  "command.settings.open.mcp": "Abrir configurações — MCP",
  "command.settings.open.breniac": "Abrir configurações — Breniac",
  ...
  "sidebar.help": "Ajuda",
  "sidebar.breniac": "Breniac",
  "breniac.state.idle": "Desligado",
  "breniac.state.listening": "Ouvindo",
  "breniac.state.speaking": "Falando",
  "breniac.state.off": "Desligado",
  "breniac.state.thinking": "Pensando",
  "breniac.state.responding": "Respondendo",
  ...
  "breniac.command.openSession": "Abrir sessão \"{{title}}\"",
  "breniac.command.openSession.untitled": "sem título",
  ...
  "settings.breniac.title": "Breniac",
  "settings.breniac.toast.saved": "Configurações do Breniac salvas",
  "settings.breniac.quickFill.button": "Usar modelos recomendados do Omniroute",
  "settings.breniac.recommended.title": "Modelos recomendados do Omniroute",
  "settings.breniac.recommended.notConnected": "O Omniroute ainda não está conectado — conecte primeiro pra escolher do catálogo ao vivo.",
  "settings.breniac.recommended.noneFound": "Nenhum dos modelos conhecidos pra esse campo foi encontrado no catálogo.",
  ...
  "settings.breniac.field.enabled.title": "Ativar o Breniac",
  "settings.breniac.field.enabled.description": "Mostra o botão do Breniac na barra lateral. Desligado por padrão.",
  ...
  "settings.breniac.field.audioModel.description": "Modelo usado na conversa de voz ao vivo (entrada e saída de áudio).",
  "settings.breniac.field.transcriptionModel.title": "Modelo de transcrição",
  "settings.breniac.field.transcriptionModel.description": "Modelo usado pra transcrever sua fala (STT).",
  "settings.breniac.field.memoryModel.title": "Modelo de memória",
  "settings.breniac.field.memoryModel.description": "Modelo usado pra resumir uma sessão de voz nos arquivos de memória.",
