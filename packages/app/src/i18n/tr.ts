...
export const dict = {
  ...
  "settings.agentui.ai.title": "Yapay Zeka ile Oluştur",
  "settings.agentui.ai.hint": "İstediğiniz ajanı kendi sözcüklerinizle tanımlayın — ad, kişilik ve ayarlar incelemeniz için aşağıda taslak olarak hazırlanacaktır.",
  "settings.agentui.ai.placeholder": "örn. Randevu sorularını yanıtlayan samimi bir diş kliniği resepsiyonisti...",
  "settings.agentui.ai.generate": "Oluştur",
  "settings.agentui.ai.generating": "Oluşturuluyor…",
  "settings.agentui.ai.toast.generated": "Taslak oluşturuldu — kaydetmeden önce inceleyin",
