...
export const dict = {
  ...
  "dialog.provider.omniroute.note": "Naudokite savo vartų URL ir raktą, visi modeliai importuojami automatiškai",
  "dialog.model.selectProvider.title": "Pasirinkite teikėją",
  "dialog.model.provider.label": "Teikėjas",
  "prompt.mode.select.title": "Pasirinkite režimą",
  "prompt.mode.auto.label": "Automatinis",
  "prompt.mode.auto.description": "Automatiškai valdo leidimų sprendimus",
  "prompt.mode.manual.label": "Rankinis",
  "prompt.mode.manual.description": "Visada klauskite prieš atliekant pakeitimus",
  "prompt.mode.edits.label": "Priimti redagavimus",
  "prompt.mode.edits.description": "Automatiškai priima visus failų redagavimus",
  "prompt.mode.plan.label": "Planas",
  "prompt.mode.plan.description": "Sukuria planą prieš atliekant pakeitimus",
  "prompt.mode.bypass.label": "Apeiti leidimus",
  "prompt.mode.bypass.description": "Priima visus šio katalogo leidimus",
  "prompt.mode.group.directory": "Šis katalogas",
  "provider.omniroute.title": "Prijungti Omniroute",
  "provider.omniroute.description": "Įveskite Omniroute vartų URL ir API raktą. Visi pasiekiami modeliai importuojami automatiškai ir suskirstomi pagal kategorijas.",
  "provider.omniroute.importing": "Importuojami modeliai...",
  "provider.omniroute.toast.imported": "Importuota {{count}} modelių",
  "provider.omniroute.toast.importedFiltered": "Importuota {{count}} modelių (praleista {{skipped}})",
  "provider.omniroute.field.combosOnly.label": "Importuoti tik derinius",
  "provider.omniroute.field.combosOnly.description": "Praleisti paprastus teikėjo / modelio įrašus ir importuoti tik derinių modelius",
  "common.confirm": "Patvirtinti",
  "common.clearSearch": "Išvalyti paiešką",
  "dialog.releaseNotes.title": "Kas naujo",
  "browser.panel.toggle": "Naršyklė",
  "browser.panel.back": "Atgal",
  "browser.panel.forward": "Pirmyn",
  "browser.panel.reload": "Perkrauti",
  "browser.panel.address.placeholder": "Įveskite URL",
  ...
  "batuta.list.create": "Nauja veikla",
  "batuta.list.empty": "Kol kas nėra veiklų. Sukurkite vieną, kad pradėtumėte.",
  "batuta.list.start": "Pradėti",
  "batuta.model.provider.placeholder": "Teikėjas",
  "batuta.model.model.placeholder": "Modelis",
  "batuta.form.title.create": "Nauja Batuta veikla",
  "batuta.form.title.edit": "Redaguoti Batuta veiklą",
  "batuta.form.field.name.label": "Pavadinimas",
  "batuta.form.field.name.placeholder": "pvz., Refaktorinti mokėjimų modulį",
  "batuta.form.field.goal.label": "Tikslas",
  "batuta.form.field.goal.placeholder": "Ką turėtų pasiekti orkestratorius?",
  "batuta.form.field.orchestrator.label": "Orkestratoriaus modelis",
  "batuta.form.field.workers.label": "Darbuotojai",
  "batuta.form.field.workers.label.placeholder": "Darbuotojo žymė",
  "batuta.form.field.workers.add": "Pridėti darbuotoją",
  "batuta.form.field.workers.error.required": "Pridėkite bent vieną darbuotoją su žyme ir modeliu arba komanda",
  "batuta.form.field.workers.kind.internal": "Vidinis",
  "batuta.form.field.workers.kind.external": "Išorinis CLI",
  "batuta.form.field.workers.command.placeholder": "Komanda (pvz., claude, codex)",
  "batuta.form.field.workers.command.needsSkill": "Pirmiausia įdiekite batuta-cli įgūdį šiam agentui skiltyje Nustatymai > Agentai",
  "batuta.form.field.workers.args.placeholder": "Argumentai (atskirti tarpais)",
  "batuta.form.field.worktree.label": "Izoliuoti darbuotojų darbo medžiai",
  "batuta.form.field.worktree.description": "Kiekvienas darbuotojas visada gauna savo git darbo medį, izoliuotą nuo pagrindinės kopijos — orkestratorius peržiūri ir sujungia kiekvieno darbuotojo rezultatą. Tai nekonfigūruojama.",
  "batuta.form.field.directory.label": "Projektas",
  "batuta.form.field.directory.description": "Aplankas, kuriame veikia šios veiklos orkestratorius ir darbuotojai.",
  "batuta.form.field.directory.error.required": "Pasirinkite arba pridėkite projekto aplanką.",
  "batuta.form.submit.create": "Sukurti",
  "batuta.form.toast.created": "Veikla „{{name}}“ sukurta",
  "batuta.form.toast.updated": "Veikla „{{name}}“ atnaujinta",
  "batuta.remove.confirm.title": "Pašalinti veiklą?",
  "batuta.remove.confirm.description": "„{{name}}“ bus visam laikui pašalinta.",
  "batuta.list.viewLive": "Žiūrėti tiesiogiai",
  "batuta.panel.title": "Tiesioginė veikla",
  "batuta.panel.empty": "Ši veikla nevykdoma. Paleiskite ją iš veiklų sąrašo, kad matytumėte tiesiogiai.",
  "batuta.panel.status.idle": "Neveikiantis",
  "batuta.panel.status.busy": "Dirbama",
  "batuta.panel.status.retry": "Bandoma iš naujo",
  "batuta.panel.architect.working": "Architektas tiria projektą ir ruošia dokumentus...",
  "batuta.panel.architect.open": "Atidaryti architekto sesiją",
  "batuta.panel.pipeline.title": "Konvejeris",
  "batuta.panel.tab.graph": "Grafikas",
  "batuta.panel.tab.pipeline": "Konvejeris",
  "batuta.panel.tab.kanban": "Kanban",
  "batuta.pipeline.kanban.pending": "Laukiama",
  "batuta.pipeline.kanban.inProgress": "Vykdoma",
  "batuta.pipeline.kanban.completed": "Baigta",
  "batuta.pipeline.kanban.empty": "Čia dar nieko nėra.",
  "batuta.pipeline.phase.planning": "Planavimas",
  "batuta.pipeline.phase.development": "Kūrimas",
  "batuta.pipeline.phase.testing": "Testavimas",
  "batuta.pipeline.phase.quality": "Kokybė",
  "batuta.pipeline.phase.delivery": "Pristatymas",
  "batuta.pipeline.definition.missing": "Konvejerio eiga dar neapibrėžta — Architektas ją apibrėš tirdamas projektą. Po to problemos rodomos sugrupuotos.",
  "batuta.pipeline.editor.open": "Redaguoti eigą",
  "batuta.pipeline.editor.title": "Konvejerio eiga",
  "batuta.pipeline.editor.description": "Bendra visoms šio projekto veikloms (docs/batuta-pipeline.md). Apibrėžkite fazes kaip antraštes „## Fazės pavadinimas“, po kiekvienos – įgūdžių žymų sąrašas (pvz., „- tdd“). Orkestratorius periodiškai iš naujo perskaito šį failą, todėl pakeitimai galioja net vykdymo metu.",
  "batuta.pipeline.editor.save": "Išsaugoti",
  "batuta.pipeline.editor.tab.editor": "Tekstas",
  "batuta.pipeline.editor.tab.chat": "Pokalbis",
  "batuta.pipeline.chat.description": "Bendraukite su sesija, apribota tik docs/batuta-pipeline.md skaitymui/rašymui — ji nerodoma sesijų sąraše ir negali paliesti nieko kito.",
  "batuta.pipeline.chat.placeholder": "Aprašykite norimą konvejerio eigos pakeitimą...",
  "batuta.pipeline.chat.send": "Siųsti",
  "batuta.pipeline.chat.empty": "Kol kas nėra pranešimų — išsiųskite vieną, kad pradėtumėte koreguoti eigą.",
  "batuta.pipeline.chat.starting": "Pradedamas pokalbis...",
  "batuta.pipeline.stage.architecture": "Architektūra",
  "batuta.pipeline.stage.architecture.detail": "Architektas ištyrė projektą pagal veiklos tikslą, parašė / atnaujino dokumentus (PRD, DER), naudojo /grill-me neaiškumams išsiaiškinti ir suskaidė darbą į užduotis.",
  "batuta.pipeline.stage.orchestration": "Orkestravimas",
  "batuta.pipeline.stage.orchestration.detail": "Orkestratorius gavo Architekto perdavimą (dokumentai + užduotys) ir pradėjo paskirstyti kiekvieną užduotį tinkamam darbuotojui ar įgūdžiui.",
  "batuta.panel.detail.open": "Atidaryti visą sesiją",
  "batuta.panel.detail.empty": "Kol kas nieko nėra — laukiama, kol šis agentas pradės dirbti.",
  "batuta.panel.ready.title": "Architektas baigė — peržiūrėkite planą prieš pradėdami",
  "batuta.panel.ready.dispatch": "Pradėti veiklą",
  "batuta.form.field.branch.label": "Šaka",
  "batuta.form.field.branch.description": "Šaka, kurioje bus pagrindinė kopija, kai prasidės veikla. Palikite aptiktą šaką tokią, kokia yra, arba įveskite naują pavadinimą, kad sukurtumėte ir persijungtumėte į ją.",
  "batuta.form.field.branch.placeholder": "Pasirinkite šaką",
  "batuta.form.field.branch.newPlaceholder": "Naujos šakos pavadinimas",
  "batuta.form.field.branch.create": "Nauja šaka",
  "settings.footer.credit": "Sukūrė: Alltomatos",
  "settings.title": "Nustatymai",
  "settings.section.customize": "Tinkinimas",
  "settings.general.section.general": "Bendra",
  "settings.general.section.experimental": "Eksperimentinis",
  "settings.general.row.use3dAnimations.title": "Naudoti 3D animacijas",
  "settings.general.row.use3dAnimations.description": "Rodyti 3D vaizdus, kai jie prieinami (pvz., Batuta veiklos scena), vietoj plokščio 2D atsarginio varianto",
  "settings.general.row.devTools.title": "Kūrėjo įrankiai",
  "settings.general.row.devTools.description": "Atidarykite Chromium DevTools (konsolę, tinklą), kad galėtumėte derinti problemas net produkcinėse versijose.",
  "settings.general.row.devTools.open": "Atidaryti DevTools",
  "settings.general.row.debugMode.title": "Derinimo režimas",
  "settings.general.row.debugMode.description": "Rodo DevTools piktogramą pavadinimo juostoje, pasiekiamą iš bet kurio ekrano, ir įjungia nuotolinio derinimo (CDP) prievadą net supakuotose / produkcinėse versijose. Reikia iš naujo paleisti programą.",
  "settings.general.row.debugMode.descriptionOn": "Įjungta — iš naujo paleiskite programą, kad įsigaliotų nuotolinio derinimo prievadas.",
  "settings.general.row.debugMode.restart": "Paleisti iš naujo dabar",
  "settings.general.row.computerUse.title": "Kompiuterio naudojimas",
  "settings.general.row.computerUse.description": "Leidžia agentui tiesiogiai valdyti šį kompiuterį — pelę, klaviatūrą ir ekraną — ne tik įterptą naršyklę. Numatytai įjungta; kiekvienas veiksmas vis tiek pirmiausia prašo patvirtinimo. Reikia iš naujo paleisti programą.",
  "settings.general.row.computerUse.descriptionOn": "Įjungta — iš naujo paleiskite programą, kad įsigaliotų kompiuterio naudojimas.",
  "settings.general.row.computerUse.restart": "Paleisti iš naujo dabar",
  "settings.providers.view.list": "Sąrašo rodinys",
  "settings.providers.view.grid": "Tinklelio rodinys",
  "settings.mcp.add.button": "Pridėti jungtį",
  ...
  "settings.mcp.add.type.local": "Vietinis (komanda)",
  "settings.mcp.add.type.remote": "Nuotolinis (URL)",
  "settings.mcp.add.field.command.label": "Komanda",
  ...
  "settings.mcp.add.field.cwd.label": "Darbo katalogas (nebūtina)",
  "settings.mcp.add.field.cwd.placeholder": "Santykinai su darbo sritimi",
  "settings.mcp.add.field.env.label": "Aplinkos kintamasis",
  "settings.mcp.add.field.headers.label": "Antraštė",
  "settings.mcp.add.field.timeout.label": "Skirtasis laikas ms (nebūtina)",
  "settings.mcp.add.field.timeout.placeholder": "5000",
  "settings.mcp.add.toast.title": "Jungtis „{{name}}“ pridėta",
  "settings.mcp.edit.title": "Redaguoti MCP jungtį",
  "settings.mcp.edit.toast.title": "Jungtis „{{name}}“ atnaujinta",
  "settings.mcp.remove.confirm.title": "Pašalinti jungtį",
  "settings.mcp.remove.confirm.description": "Pašalinti „{{name}}“ iš jūsų MCP serverių? Tai ištrina jį iš konfigūracijos, o ne tik atjungia.",
  "settings.mcp.remove.button": "Pašalinti",
  "settings.mcp.remove.toast.title": "Jungtis „{{name}}“ pašalinta",
  "settings.mcp.auth.connect.button": "Prijungti",
  "settings.mcp.auth.needsClientRegistration.hint": "Šiam serveriui reikia iš anksto registruoto OAuth kliento. Redaguokite šią jungtį ir įveskite OAuth kliento ID / paslaptį.",
  "settings.mcp.add.field.oauthClientId.label": "OAuth kliento ID (nebūtina)",
  "settings.mcp.add.field.oauthClientSecret.label": "OAuth kliento paslaptis (nebūtina)",
  "settings.mcp.catalog.toggle": "Rodyti įrankius",
  "settings.mcp.catalog.empty": "Šis serveris nesuteikia jokių įrankių, užklausų ar išteklių.",
  "settings.mcp.catalog.tools": "Įrankiai ({{count}})",
  "settings.mcp.catalog.prompts": "Užklausos ({{count}})",
  "settings.mcp.catalog.resources": "Ištekliai ({{count}})",
  "settings.skills.title": "Įgūdis",
  "settings.skills.empty": "Įgūdžių nerasta",
  "settings.skills.sources.title": "Šaltiniai",
  "settings.skills.sources.claude.title": "Žiūrėti Claude įgūdžius",
  "settings.skills.sources.claude.description": "Aptikti įgūdžius iš ~/.claude/skills",
  "settings.skills.sources.codex.title": "Žiūrėti Codex įgūdžius",
  "settings.skills.sources.codex.description": "Aptikti įgūdžius iš ~/.codex/skills",
  "settings.skills.installed.title": "Aptikti įgūdžiai",
  "settings.externalAgents.title": "Agentai",
  "settings.externalAgents.refresh": "Atnaujinti",
  "settings.externalAgents.selectAll.title": "Pasirinkti visus aptiktus agentus",
  "settings.externalAgents.selectAll.description": "Įdiegia batuta-cli įgūdį kiekvienam aptiktam agentui. Išjunkite, jei norite rinktis agentus atskirai.",
  "settings.externalAgents.status.detected": "Aptikta prijungtame serveryje",
  "settings.externalAgents.status.notDetected": "Neaptikta — įdiekite CLI ir spustelėkite Atnaujinti",
  "settings.marketplace.title": "Rinkos vieta",
  "settings.marketplace.add.button": "Pridėti",
  "settings.marketplace.skills.add.title": "Pridėti įgūdžių šaltinį",
  "settings.marketplace.skills.add.description": "Pridėkite URL, kuris pateikia su opencode suderinamą įgūdžių manifestą.",
  "settings.marketplace.skills.add.placeholder": "https://example.com/.well-known/skills/",
  "settings.marketplace.mcp.add.title": "Pridėti MCP jungtį",
  "settings.marketplace.suggestions.title": "Pasiūlymai",
  "settings.marketplace.suggestions.use": "Naudoti",
  "settings.marketplace.skills.suggestions.description": "Nepatikrinta pagal opencode įgūdžių manifesto formatą — įklijuokite tikrą katalogo URL patvirtinimui prieš importuojant bet ką.",
  "settings.marketplace.catalogs.title": "Katalogai",
  "settings.marketplace.catalogs.view": "Žiūrėti",
  "common.remove": "Pašalinti",
  "server.remove.title": "Pašalinti serverį",
  "server.remove.confirm": "Pašalinti serverį „{{name}}“? Jame esantys projektai ir sesijos čia daugiau nebus rodomi.",
  "server.remove.button": "Pašalinti serverį",
