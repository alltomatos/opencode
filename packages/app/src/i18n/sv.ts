export const dict = {
  ...
  "settings.agentui.ai.title": "Skapa med AI",
  "settings.agentui.ai.hint": "Beskriv agenten du vill ha med egna ord — namn, personlighet och inställningar utarbetas nedan för granskning.",
  "settings.agentui.ai.placeholder": "t.ex. En vänlig receptionist på en tandläkarmottagning som svarar på frågor om tider...",
  "settings.agentui.ai.generate": "Generera",
  "settings.agentui.ai.generating": "Genererar…",
  "settings.agentui.ai.toast.generated": "Utkast genererat — granska innan du sparar",
