...
export const dict = {
  ...
  "settings.agentui.ai.title": "用 AI 创建",
  "settings.agentui.ai.hint": "用你自己的话描述你想要的代理 — 名称、个性和设置将在下方生成草稿供你审查。",
  "settings.agentui.ai.placeholder": "例如：一位友好的牙科诊所前台，负责回答预约相关问题……",
