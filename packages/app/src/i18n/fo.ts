export const dict = {
  ...
  "settings.agentui.ai.title": "Ger við AI",
  "settings.agentui.ai.hint": "Lýstu umboðsmanninum, sum tú vilt, við tínum egnu orðum — navn, persónleiki og stillingar verða gjørd niðanfyri til eftirsjón.",
  "settings.agentui.ai.placeholder": "t.d. Ein vinaligur móttøkufólk á tannlæknastovu, ið svarar spurningum um tíðir...",
  "settings.agentui.ai.generate": "Ger",
  "settings.agentui.ai.generating": "Ger…",
  "settings.agentui.ai.toast.generated": "Uppskot gjørt — eftirsí áðrenn goymt verður",
