...
| [**[E17] Otimização de Performance e Latência de UI/Navegação**](https://github.com/alltomatos/opencode/issues/228) | Otimização de queries SQLite, transição de timeline sem render stall, favicon glob e desoneração do boot desktop | in_progress | [#228](https://github.com/alltomatos/opencode/issues/228) |
...
- **Epics vinculadas:**
  ...
  - [**[E17] Otimização de Performance e Latência de UI/Navegação**](https://github.com/alltomatos/opencode/issues/228) (`in_progress`)
- **Estado:** `in_progress`
